...
namespace CMS.Core.Migrations
{
    ...
    [Migration("20210318045046_playersadded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMS.Core.Entity.ItemCategory", b =>
                {
                    b.Property<long>("designing_category_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("designing_category_id");
            ...
            modelBuilder.Entity("CMS.Core.Entity.Partners", b =>
                {
                    b.Property<long>("partners_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CMS.Core.Entity.Product", b =>
                {
                    b.Property<long>("designing_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("designing_id");

                    b.HasIndex("designing_category_id");
            ...
            modelBuilder.Entity("CMS.Core.Entity.Specialities", b =>
                {
                    ...
                    b.Property<string>("image_name_four")
                        .HasMaxLength(70);

                    b.Property<string>("image_name_three")
                        .HasMaxLength(70);
                    ...
                    b.Property<long>("project_category_id");
                    ...
                    b.HasIndex("project_category_id");

                    b.ToTable("specialities");
                });

            modelBuilder.Entity("CMS.Core.Entity.SpecialitiesCategory", b =>
                {
                    b.Property<long>("project_category_id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("project_category_id");

                    b.ToTable("specialitiesCategories");
                });
            ...
            modelBuilder.Entity("CMS.Core.Entity.Product", b =>
                {
                    b.HasOne("CMS.Core.Entity.ItemCategory", "item_category")
                        .WithMany("products")
                        .HasForeignKey("designing_category_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("CMS.Core.Entity.Specialities", b =>
                {
                    b.HasOne("CMS.Core.Entity.SpecialitiesCategory", "specialities_category")
                        .WithMany("specialities")
                        .HasForeignKey("project_category_id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
